...
def get_args():
    ...
    parser.add_argument('--iog_obj_idx', type=int, default=0,
                        help='an object index from the corresponding annotation which you want to segment')
...
if __name__ == '__main__':
    ...
    obj_idx = opt.iog_obj_idx if opt.iog_obj_idx < len(input_annotations['analysis_results']) else 0
    input_annotations['analysis_results'] = [input_annotations['analysis_results'][obj_idx]]
