...
from pytorch_deseg_module.zyolo_efficientdet.efficientdet.dataset import CocoDataset, CocoAlbumentationsDatasetV2, Resizer, Normalizer, Augmenter, collater
...
def train(opt):
    ...
    training_set = CocoAlbumentationsDatasetV2(root_dir=os.path.join(opt.data_path, params.project_name), set=params.train_set,
                                               transform=Albumentations(params),
